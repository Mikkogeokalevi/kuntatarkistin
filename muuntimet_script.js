/*
  MK MUUNTIMET
  Versio 16.1 - Täydellinen ja korjattu
*/
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function main() {
        ...
        // --- TÄSTÄ ALASPÄIN KAIKKI ALUSTUSFUNKTIOT ---
        ...
        const alustaTypografiaMuunnin = () => {
            ...
            [mistaSelect, mihinSelect].forEach(select => {
                typoYksikot.forEach(u => { const option = new Option(u.name, u.sym); if (u.selite) option.title = u.selite; select.add(option); });
            });
