/*
  MK MUUNTIMET
  Versio 6.1 - Lisätty puuttuvia pituus- ja pinta-alayksiköitä
*/
document.addEventListener('DOMContentLoaded', () => {
    ...
    const yksikot = {
        pituus: [ 
            ...
            { sym: 'dm', name: 'Desimetri', kerroin: 0.1 },
            { sym: 'm', name: 'Metri', kerroin: 1 },
            { sym: 'dam', name: 'Dekametri', kerroin: 10 },
            { sym: 'hm', name: 'Hehtometri', kerroin: 100 },
            { sym: 'km', name: 'Kilometri', kerroin: 1000 },
            { sym: 'myriametri', name: 'Myriametri', kerroin: 10000 },
        ...
        pinta_ala: [ 
            ...
            { sym: 'dm²', name: 'Neliödesimetri', kerroin: 0.01 },
        ...
        tilavuus: [ 
            { sym: 'ml', name: 'Millilitra', kerroin: 0.001 }, { sym: 'cl', name: 'Senttilitra', kerroin: 0.01 }, { sym: 'dl', name: 'Desilitra', kerroin: 0.1 }, { sym: 'l', name: 'Litra', kerroin: 1 }, { sym: 'm³', name: 'Kuutiometri', kerroin: 1000 }, { sym: 'gal_us', name: 'Gallona (US)', kerroin: 3.78541 }, { sym: 'gal_uk', name: 'Gallona (UK)', kerroin: 4.54609 }, { sym: 'kannu', name: 'Kannu (vanha)', kerroin: 2.617 }, { sym: 'tuoppi', name: 'Tuoppi (vanha)', kerroin: 1.309 }, { sym: 'kortteli', name: 'Kortteli (vanha)', kerroin: 0.327 }, { sym: 'jumpru', name: 'Jumpru (vanha)', kerroin: 0.08175 }, { sym: 'kappa', name: 'Kappa (vanha)', kerroin: 4.58 }, { sym: 'tynnyri_neste', name: 'Tynnyri, neste (vanha)', kerroin: 125.6 }, { sym: 'aami', name: 'Aami (vanha)', kerroin: 157 }, { sym: 'tynnyri_kuiva', name: 'Tynnyri, kuiva (vanha)', kerroin: 146.5 } 
        ],
