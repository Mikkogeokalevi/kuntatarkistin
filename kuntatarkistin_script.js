/*
  ...
  Versio 26.3 - Laajennettu ja järjestelty versiohistoria
*/

// --- VERSIOHISTORIAN DATA ---
const versiohistoriaData = [
    { versio: "26.3", kuvaus: ["Laajennettu ja järjestelty koko versiohistoria käyttäjän toimittamien tietojen pohjalta."] },
    { versio: "26.2", kuvaus: ["Muutettu versiohistoria dynaamiseksi."] },
    { versio: "26.1", kuvaus: ["Korjattu kriittinen virhe, jossa osa ohjelman funktioista puuttui."] },
    { versio: "26.0", kuvaus: ["Lisätty staattinen versiohistoria-välilehti."] },
