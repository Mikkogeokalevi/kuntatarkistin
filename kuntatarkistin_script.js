/*
  ...
  Versio 26.2 - Dynaaminen versiohistoria
*/

// --- VERSIOHISTORIAN DATA ---
const versiohistoriaData = [
    { versio: "26.2", kuvaus: ["Muutettu versiohistoria dynaamiseksi. Se päivittyy nyt automaattisesti."] },
    { versio: "26.1", kuvaus: ["Korjattu kriittinen virhe, jossa osa ohjelman funktioista puuttui."] },
    { versio: "26.0", kuvaus: ["Lisätty versiohistoria-välilehti (staattinen)."] },
    { versio: "25.0", kuvaus: ["Täysin uusittu ulkoasu ja värimaailma.", "Lisätty teemanvalitsin (4 teemaa), jonka valinta tallentuu.", "Siirretty toimintoja välilehtien alle mobiilikäytön helpottamiseksi.", "Lisätty 'Täytyy käydä'-listaan kuntahaku ja karttamerkinnät."] },
    ...
    { versio: "20.0", kuvaus: ["Lisätty 'Keskitä minuun' -pikanappi kartalle.", "Parannettu zoomausta ja lisätty latausindikaattori.", "Sovellus muistaa nyt valitun karttatyylin."] },
    { versio: "19.0", kuvaus: ["Korjattu kunnan nimen tunnistuslogiikka toimimaan luotettavammin."] },
    { versio: "14.0", kuvaus: ["Parannettu etäisyyslaskuri: tukee useita pisteitä ja näyttää välimatkat."] },
    { versio: "13.0", kuvaus: ["Sijaintihistoria tallennetaan selaimeen.", "URL päivittyy sijainnin mukaan, mahdollistaen linkkien jakamisen."] }
];
...
function tyhjennaHistoria() { if(confirm("Haluatko varmasti tyhjentää sijaintihistorian?")) { sijaintiHistoria = []; localStorage.removeItem('mk_kuntatarkistin_historia'); paivitaHistoria(); naytaViesti('Historia tyhjennetty'); } }
